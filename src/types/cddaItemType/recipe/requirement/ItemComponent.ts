...
export class ItemComponent extends MyClass<ItemComponent> {
  name!: CddaItemRef;
  count!: number;
  ...
  fromJson(jsonObject: [string, number, string | undefined]): ItemComponent | undefined {
    const result = new ItemComponent();
